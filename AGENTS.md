# BaseUniv3WethCbbtcYieldStrategy - Agent Guide

> AI coding agent context for the `base_univ3_weth_cbbtc_yield` strategy.

## Overview

- **Template:** dynamic_lp
- **Chain:** base
- **Class:** `BaseUniv3WethCbbtcYieldStrategy` in `strategy.py`
- **Config:** `config.json`
